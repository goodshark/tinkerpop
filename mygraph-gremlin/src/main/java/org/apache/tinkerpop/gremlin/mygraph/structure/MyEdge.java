...
public class MyEdge extends MyElement implements Edge {
    protected Map<String, Property> properties;
    protected final Vertex inVertex;
    protected final Vertex outVertex;

    protected MyEdge(final Object id, final Vertex outVertex, final String label, final Vertex inVertex) {
        super(id, label);
        this.outVertex = outVertex;
        this.inVertex = inVertex;
        MyHelper.autoUpdateIndex(this, T.label.getAccessor(), this.label, null);
    }
    ...
    public <V> Property<V> property(String key, V value) {
        ...
        final Property<V> newProperty = new MyProperty<>(this, key, value);
        if (null == this.properties) this.properties = new HashMap<>();
        this.properties.put(key, newProperty);
        MyHelper.autoUpdateIndex(this, key, value, oldProperty.isPresent() ? oldProperty.value() : null);
        return newProperty;
    }
    ...
    @Override
    public void remove() {
        final MyVertex outVertex = (MyVertex) this.outVertex;
        final MyVertex inVertex = (MyVertex) this.inVertex;
        ...
        ((MyGraph) this.graph()).edges.remove(this.id());
